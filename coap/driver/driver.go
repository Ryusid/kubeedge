...
func (c *CustomizedClient) InitDevice() error {
	...
	// Validate required configuration - access through embedded ConfigData
	...
	conn, err := udpClient.Dial(c.ProtocolConfig.Addr)
	if err != nil {
...
func (c *CustomizedClient) GetTwinData(deviceID string, grpcClient *common.EdgeCoreClient) error {
	return nil
}
